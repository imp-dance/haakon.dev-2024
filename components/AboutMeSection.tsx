    ...
    <Container>
      <InnerContainer>
        <div>
          <h2>tl;dr</h2>
          <p>
            I am {getAge()} year old Norwegian, currently I live
            in my hometown of{" "}
            <Link
          ...
          <p>
            ...
            using collaborative tools and task management
            services - that is when I am most comfortable.
            Fine-tuning accessible and creative user experiences
            using React and Typescript.
          </p>
          <p>
            I am an expert in all of the front-end fundamentals
            such as <code>HTML</code>, <code>CSS</code> and{" "}
            <code>Javascript</code>, as well as{" "}
            <code>React</code> and <code>Typescript</code>.
          </p>
          <Disclose
            variant="ghost"
            showText="Read more"
            ...
            <>
              ...
              <p>
                ...
                >
                  ...
                  out in the (no longer existing) webs.com /
                  freewebs community.
                </blockquote>{" "}
              ...
              <p>
                ...
                (previously Idean, part of Capgemini). At Idean,
                I was able to work on a couple of projects at
...
const Container = styled.div`
  min-height: 100dvh;
  background: url(/molly_sleep.jpg) no-repeat center center;
  background-size: 70%;
